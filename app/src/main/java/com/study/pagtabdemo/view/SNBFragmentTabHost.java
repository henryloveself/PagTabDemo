 ...
 * https://blog.csdn.net/qq_35605213/article/details/87805740
 */
public class SNBFragmentTabHost extends TabHost implements
    ...
    public SNBFragmentTabHost(Context context) {
    ...
    public SNBFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
